...
static inline void __list_add(struct list_head *elm,
...
#else
extern void __list_add(struct list_head *elm,
			      struct list_head *prev,
			      struct list_head *next);
#endif
 ...
 */
static inline void list_add(struct list_head *elm, struct list_head *head)
{
 ...
 */
static inline void list_add_tail(struct list_head *elm, struct list_head *head)
{
